...
const Structure = () => {
    ...
    useEffect(() => {
        fetch('http://172.16.3.101:8000/api/departments?active=0&from=0', {
            headers: {
    ...
    const updateList = (page) => {
        fetch('http://172.16.3.101:8000/api/departments?active=0&from=' + page, {
            headers: {
                'Authorization': 'Bearer ' + token
            }
        })
...
const NewStructureRow = (props) => {
    ...
    const addStructure = () => {
        ...
        fetch('http://172.16.3.101:8000/api/new-structure', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer ' + token,
...
const TableRow = (props) => {
    ...
    const handleDone = () => {
        ...
        fetch('http://172.16.3.101:8000/api/update-structure', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Content-Length': data.length,
